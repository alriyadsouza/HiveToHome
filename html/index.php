            ...
            <div id="primary" class="content-area front-page-content-area">
                ...
                <section id="banner" class="section banner-section" data-eltype="frontpagesection" style="background-image: url(images/IMG_1632.jpeg); position: relative;">
                    ...
                    <section id="contact" class="section contact-section" data-eltype="frontpagesection">
                        <div class="section-inner">
                            <div class="bg-contact" style="background-image:url(images/19.jpg);">
                            ...
                            <div class="contact-content">
                                <div class="newsletter-col">
                                    ...
                                    <div role="form" class="wpcf7" id="wpcf7-f5-p6-o1">
                                        <div class="screen-reader-response"></div>
                                        <form class="wpcf7-form">
                                            <div class="step1">
                                                <label>
                                                    <span class="wpcf7-form-control-wrap date-772">
                                                        <input type="text" name="date-772" value="" size="40" class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required" aria-required="true" placeholder="Select Date" required />
                                                    </span>
                                                </label>
                                                <label>
                                                    <span class="wpcf7-form-control-wrap time-398">
                                                        <input type="text" name="time-398" value="" size="40" class="wpcf7-form-control wpcf7-date wpcf7-time wpcf7-validates-as-required" aria-required="true" placeholder="Time" required />
                                                    </span>
                                                </label>
                                                <label class="boc-slect">
                                                    <span class="wpcf7-form-control-wrap amount">
                                                        <select name="amount" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false">
                                                            <option value="">---</option>
                                                ...
                                                <p><input type="submit" value="Reserve a Table" class="wpcf7-form-control wpcf7-submit" />
                                                </p>
                                            </div>
                                    ...
                                    <div class="section-subbottom">
                                        <p>Or Call : <a href="tel:">1-800-123-456789</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
